...
- [ ] T003 [P] Configure linting and formatting tools (ESLint, Prettier per constitution)
- [ ] T004 [P] Setup testing framework (for TDD mandate)
- [ ] T005 [P] Configure accessibility testing tools (WCAG 2.1 AA compliance)
- [ ] T006 [P] Setup performance monitoring (Lighthouse CI, bundle analysis)
...
- [ ] T013 [P] Implement responsive design utilities (mobile-first, breakpoints)
- [ ] T014 [P] Create base accessible components (keyboard nav, ARIA)
...
- [ ] T017 [P] [US1] Accessibility test (keyboard nav, ARIA, contrast) in tests/a11y/test_[name].js
- [ ] T018 [P] [US1] Performance test (Lighthouse score, bundle size) in tests/perf/test_[name].js
...
- [ ] T023 [US1] Add validation and user-friendly error messages
- [ ] T024 [US1] Ensure responsive design (320px+, mobile-first)
- [ ] T025 [US1] Verify WCAG 2.1 AA compliance (contrast, semantic HTML, ARIA)
