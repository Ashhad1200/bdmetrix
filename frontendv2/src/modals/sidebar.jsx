                        ...
                        <div className="offcanvas__contact">
                            ...
                            <div className="offcanvas__contact-content d-flex">
                                ...
                                <div className="offcanvas__contact-content-content">
                                    <a href="http://bdmatrix.org/" target="_blank">Worldwide Service | 20+ Countries</a>
                                </div>
                            </div>
                            <div className="offcanvas__contact-content d-flex">
                                <div className="offcanvas__contact-content-icon">
                                ...
                                <div className="offcanvas__contact-content-content">
                                    <a href="mailto:support@bdmatrix.org">support@bdmatrix.org</a>
                                </div>
                            </div>
                            <div className="offcanvas__contact-content d-flex">
                                <div className="offcanvas__contact-content-icon">
                                ...
                                <div className="offcanvas__contact-content-content">
                                    <a href="tel:+15817051620">+1 (581) 705-1620</a>
                                </div>
                            </div>
                        </div>
                        <div className="offcanvas__social">
                            <a className="icon facebook" href="https://www.facebook.com/profile.php?id=61585293039839" target="_blank"><i className="fab fa-facebook-f"></i></a>
